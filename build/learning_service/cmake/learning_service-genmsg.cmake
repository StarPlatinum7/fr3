...
get_filename_component(_filename "/home/sunny/catkin_ws/src/learning_service/srv/Person.srv" NAME_WE)
add_custom_target(_learning_service_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_service" "/home/sunny/catkin_ws/src/learning_service/srv/Person.srv" ""
)
...
_generate_srv_cpp(learning_service
  "/home/sunny/catkin_ws/src/learning_service/srv/Person.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_service)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_service\")")
  # install generated code
  install(
