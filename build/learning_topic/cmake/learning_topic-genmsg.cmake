...
set(MSG_I_FLAGS "-Ilearning_topic:/home/sunny/catkin_ws/src/learning_topic/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/sunny/catkin_ws/src/learning_topic/msg/Person.msg" NAME_WE)
add_custom_target(_learning_topic_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_topic" "/home/sunny/catkin_ws/src/learning_topic/msg/Person.msg" ""
)
...
_generate_msg_cpp(learning_topic
  "/home/sunny/catkin_ws/src/learning_topic/msg/Person.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_topic)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_topic\")")
  # install generated code
  install(
